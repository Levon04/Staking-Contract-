...
contract HopOnYop
{
    ...
    uint8 constant public reward1 = 6; uint256 constant public stakedFor1 = 3 seconds; //6% reward for 30 days lock
    uint8 constant public reward2 = 15; uint256 constant public stakedFor2 = 3 seconds; //15% reward for 60 days lock
    uint8 constant public reward3 = 33; uint256 constant public stakedFor3 = 3 seconds; //33% reward for 90 days lock

    
    uint256 private constant minStake = 88;
    uint256 private constant maxStake = 33333;
